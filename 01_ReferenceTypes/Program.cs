...
namespace _01_ReferenceTypes
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string declarationAndInitialization = "This is both declaring and initializing.";// string is a collection of characters
            ...
            Stack<string> lastIntFirstOut = new Stack<string>();
